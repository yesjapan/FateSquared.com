...
| `author.jpg` | ⚠️ stand-in | Cropped out of the back cover — only 200×262 px, so it's soft on retina screens. **Replace with the original portrait** (any size ≥ 720×900, 4:5 crop). Same filename. |
